...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="page-content">
            ...
            <button class="btn btn-success"> <a href="<?php echo site_Url; ?>addprofile.php" style="color:white">Add Profile</a> </button>
            ...
            <table  class="table table-striped">
                ...
                <tr>
                    ...
                    <td><a href="profileedit.php?id=<?php echo $sel_res['id']; ?>" class="fa fa-edit btn btn-success"></a></td>
                </tr>
                <?php
                }
                ?>
