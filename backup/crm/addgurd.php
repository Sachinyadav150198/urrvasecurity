            ...
            <form action="gurdformcode.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    <div class="col-sm-4">
                        ...
                        <input type="number" class="form-control" name="refid" placeholder="Aaddhar Number">
                    </div>
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="number" class="form-control" name="refnum" placeholder="Reference Mobile">
                    </div>
                </div> <br> <br>
                ...
                <div class="form-row">
                    <div class="col-sm-4">
                        ...
                        <input type="date" class="form-control" name="refdob" placeholder="Reference name">
                    </div>
                    <div class="col-sm-4">
