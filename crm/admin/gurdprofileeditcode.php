...
<?php
    ...
    // $verification = $_FILES['police']['name'];
    ...
    // foreach($_FILES['verification']['tmp_name'] as $key =>$image )
    // {
    //     $verification1 = $_FILES['verification']['tmp_name'][$key];
    //     $verification = $_FILES['verification']['name'][$key];
    //     $r = move_uploaded_file($verification1, $location[$key]. $verification);
    // }
